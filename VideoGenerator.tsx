...
const VideoGenerator: React.FC = () => {
  ...
  // Mandatory step before accessing the app for Veo models.
  useEffect(() => {
  ...
  const handleGenerate = async () => {
    ...
    try {
      ...
      if (error.message?.includes('Requested entity was not found')) {
        // Reset and prompt to select key again.
        // @ts-ignore
  ...
  return (
    <div className="max-w-4xl mx-auto space-y-8 pb-10">
      ...
      <div className="bg-white/5 p-4 rounded-xl text-xs text-slate-400 text-center">
        Hulp nodig bij billing? Zie de <a href="https://ai.google.dev/gemini-api/docs/billing" target="_blank" rel="noreferrer" className="text-indigo-400 underline">documentatie</a>.
      </div>
